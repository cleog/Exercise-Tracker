...
const findExerciseById = async (_id) => {
    const searchResult = Exercise.findById(_id)
...
const replaceExercise = async(_id, name, reps, weight, unit, date) => {
    ...
    // return result.modifiedCount; hint suggested using matchedCount instead of modifiedCount 
}
